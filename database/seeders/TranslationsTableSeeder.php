...
class TranslationsTableSeeder extends Seeder
{
    ...
    private function dataTypesTranslations()
    {
        ...
        $dtp = DataType::where($_fld, __('voyager::seeders.data_types.lesson.singular'))->firstOrFail();
        if ($dtp->exists) {
        ...
        $dtp = DataType::where($_fld, __('voyager::seeders.data_types.lesson.plural'))->firstOrFail();
        if ($dtp->exists) {
